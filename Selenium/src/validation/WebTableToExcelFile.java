...
public class WebTableToExcelFile {
    ...
    public static void webtableToExcel(){
        ...
        try{
            ...
            oBrowser.navigate().to("file:///D:/TESTING/HTML/SampleWebTable.html");
            Thread.sleep(2000);
            ...
            fout = new FileOutputStream("D:\\TESTING\\HTML\\StudentDetails.xlsx");
            wb.write(fout);
        }catch(Exception e){
            e.printStackTrace();
        }finally{
