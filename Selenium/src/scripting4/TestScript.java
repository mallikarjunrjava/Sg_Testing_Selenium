   ...
   //-----------Scripting4 code-----------------------------------
    ...
    public static void TS_LoginLogout(){
        ...
        try {
            ...
            System.out.println("Exception in 'TS_LoginLogout() ' Test script4_Excelfile");;
        }
        finally {
            oBrowser.close();
            oBrowser=null;
    ...
    public static void TS_CreateAndDeleteUser(){
        ...
        try {
            ...
            System.out.println("Exception in 'TS_CreateAndDeleteUser() ' Test script4_Excelfile");
        }
        finally {
            oBrowser.close();
            oBrowser=null;
...
/*
      ...
      // -------------------TestNg Using @DataProvider() without using main()-------------------
...
/*
   // --------------TestNG Using @Parameters() without using main():----------------------------
...
// TestNG Using Paralell Execution.
